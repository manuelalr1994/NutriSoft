...
class RegistrarPacientes(CreateView):
    ...
    template_name = 'pacientes/datos_generales/registro_pacientes.html'
    success_url = reverse_lazy('pacientes:datos_generales:registrado_pacientes')

class RegistradoPacientes(TemplateView):
    template_name = 'pacientes/datos_generales/registrado_pacientes.html'

class ListaPacientes(ListView):
    model = Pacientes
    template_name = 'pacientes/datos_generales/lista_pacientes.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect('pacientes:datos_generales:lista_pacientes')



class ConsultarPacientes(DetailView):
    model = Pacientes
    template_name = 'pacientes/datos_generales/consulta_pacientes.html'